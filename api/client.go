...
func (api *API) GetRequest(url, singPath string, params *params.Params, inOut any) error {
	client := &http.Client{}
...
func (api *API) PostRequest(url, singPath string, params any, inOut any) error {
